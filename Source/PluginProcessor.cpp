...
UnitySynthesiserAudioProcessor::UnitySynthesiserAudioProcessor()
     :  AudioProcessor (BusesProperties()
        ...
        m_envelopeRange(juce::NormalisableRange<float>(0.01, 20, 0.01)),
        m_valueTree(*this, nullptr, "Parameters",
                    {std::make_unique<juce::AudioParameterBool>("playing", "Playing", 0),
                     ...
                     std::make_unique<juce::AudioParameterFloat>("nAttack", "Noise Attack", m_envelopeRange, m_noiseEnvelopeA),
                     std::make_unique<juce::AudioParameterFloat>("nDecay", "Noise Decay", m_envelopeRange, m_noiseEnvelopeD),
                     std::make_unique<juce::AudioParameterFloat>("nSustain", "Noise Sustain", 0.1f, 1.0f, m_noiseEnvelopeS),
                     std::make_unique<juce::AudioParameterFloat>("nRelease", "Noise Release", m_envelopeRange, m_noiseEnvelopeR),
                     ...
                     std::make_unique<juce::AudioParameterFloat>("op01A", "Operator01 Attack", m_envelopeRange, 0.1f),
                     std::make_unique<juce::AudioParameterFloat>("op01D", "Operator01 Decay", m_envelopeRange, 0.1),
                     std::make_unique<juce::AudioParameterFloat>("op01S", "Operator01 Sustain", 0.001f, 1.0f, 0.5f),
                     std::make_unique<juce::AudioParameterFloat>("op01R", "Operator01 Release", m_envelopeRange, 0.1f),
                     ...
                     std::make_unique<juce::AudioParameterFloat>("op02A", "Operator02 Attack", m_envelopeRange, 0.1f),
                     std::make_unique<juce::AudioParameterFloat>("op02D", "Operator02 Decay", m_envelopeRange, 0.1),
                     std::make_unique<juce::AudioParameterFloat>("op02S", "Operator02 Sustain", 0.001f, 1.0f, 0.5f),
                     std::make_unique<juce::AudioParameterFloat>("op02R", "Operator02 Release", m_envelopeRange, 0.1f),
                     ...
                     std::make_unique<juce::AudioParameterFloat>("op03A", "Operator03 Attack", m_envelopeRange, 0.1f),
                     std::make_unique<juce::AudioParameterFloat>("op03D", "Operator03 Decay", m_envelopeRange, 0.1),
                     std::make_unique<juce::AudioParameterFloat>("op03S", "Operator03 Sustain", 0.01f, 1.0f, 0.5f),
                     std::make_unique<juce::AudioParameterFloat>("op03R", "Operator03 Release", m_envelopeRange, 0.1f),
                    ...
                    std::make_unique<juce::AudioParameterFloat>("op04A", "Operator04 Attack", m_envelopeRange, 0.1f),
                    std::make_unique<juce::AudioParameterFloat>("op04D", "Operator04 Decay", m_envelopeRange, 0.1),
                    std::make_unique<juce::AudioParameterFloat>("op04S", "Operator04 Sustain", 0.01f, 1.0f, 0.5f),
                    std::make_unique<juce::AudioParameterFloat>("op04R", "Operator04 Release", m_envelopeRange, 0.1f),
