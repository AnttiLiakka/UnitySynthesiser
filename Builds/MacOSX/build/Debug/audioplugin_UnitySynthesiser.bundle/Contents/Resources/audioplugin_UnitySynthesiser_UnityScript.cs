...
public class audioplugin_UnitySynthesiserGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_UnitySynthesiser"; } }
    public override string Description    { get { return "UnitySynthesiser"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_UnitySynthesiser")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_UnitySynthesiser")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_UnitySynthesiser")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_UnitySynthesiser")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_UnitySynthesiser")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_UnitySynthesiser")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_UnitySynthesiser")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
